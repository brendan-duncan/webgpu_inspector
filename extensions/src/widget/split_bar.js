...
export class SplitBar extends Div {
  ...
  pointerDownEvent(e) {
    ...
    if (this._prevWidget) this._prevWidget._startResize();
    if (this._nextWidget) this._nextWidget._startResize();
  ...
  pointerUpEvent() {
    ...
    for (let w of this.parent.children) w.repaint(true);
    return false;
  }
}
