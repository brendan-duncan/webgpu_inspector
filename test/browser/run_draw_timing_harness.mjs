// Drives test/browser/draw_timing_harness.html in headless Chrome and reports
// the results. Uses the MCP plugin server's puppeteer-core.
// Run with: node test/browser/run_draw_timing_harness.mjs
...
try {
    ...
    await page.goto(`http://127.0.0.1:${port}/test/browser/draw_timing_harness.html`);
