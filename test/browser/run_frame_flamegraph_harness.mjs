// Drives test/browser/frame_flamegraph_harness.html in headless Chrome and reports
// the results. Uses the MCP plugin server's puppeteer-core.
// Run with: node test/browser/run_frame_flamegraph_harness.mjs
...
try {
    ...
    await page.goto(`http://127.0.0.1:${port}/test/browser/frame_flamegraph_harness.html`);
